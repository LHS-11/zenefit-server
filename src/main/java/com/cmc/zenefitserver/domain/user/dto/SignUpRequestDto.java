...
public class SignUpRequestDto {
    ...
    @Builder
    public SignUpRequestDto(String email, ProviderType provider, String nickname, int age, AreaCode areaCode, CityCode cityCode, int lastYearIncome, EducationType educationType, Set<JobType> jobs, Gender gender) {
        this.email = email;
