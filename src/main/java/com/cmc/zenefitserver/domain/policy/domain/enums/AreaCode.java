...
public enum AreaCode {
    ...
    GYEONGGI("003002008", "경기", Arrays.asList(
            ...
            GYEONGGI_BUCHEON, GYEONGGI_GWANGMYEONG, GYEONGGI_PYONGTAEK,
            GYEONGGI_DONGDUCHEON, GYEONGGI_ANSAN, GYEONGGI_GOYANG, GYEONGGI_GWACHEON,
            GYEONGGI_GURI, GYEONGGI_NAMYANGJU, GYEONGGI_OSAN, GYEONGGI_SIHEUNG,
            GYEONGGI_GUNPO, GYEONGGI_UIWANG, GYEONGGI_HANAM, GYEONGGI_YONGIN,
            GYEONGGI_PAJU, GYEONGGI_ICHEON, GYEONGGI_ANSEONG, GYEONGGI_GIMPO,
            GYEONGGI_HWASEONG, GYEONGGI_GWANGJU, GYEONGGI_YANGJU, GYEONGGI_POCHUN,
            GYEONGGI_YEOJU, GYEONGGI_YEONCHEON, GYEONGGI_YANGPYEONG
    )),
    ...
    CHUNGBUK("003002010", "충북", Arrays.asList(
            ...
            CHUNGBUK_OKCHEON, CHUNGBUK_YEONGDONG, CHUNGBUK_YEONGDONG, CHUNGBUK_JEUNGPYEONG,
            CHUNGBUK_JINCHEON, CHUNGBUK_GOESAN
    )),
    CHUNGNAM("003002011", "충남", Arrays.asList(
            ...
            CHUNGNAM_GEUMSAN, CHUNGNAM_BUYEO, CHUNGNAM_SEOCHEON, CHUNGNAM_CHEONGYANG, CHUNGNAM_HONGSEONG,
            CHUNGNAM_YESAN, CHUNGNAM_TAEAN
    )),
    ...
    JEONNAM("003002013", "전남", Arrays.asList(
            ...
            JEONNAM_HAMPYEONG, JEONNAM_YEONGGWANG, JEONNAM_WANDO, JEONNAM_JINDO,
            JEONNAM_SINAN
    )),
    GYEONGBUK("003002014", "경북", Arrays.asList(
            ...
            GYEONGBUK_MUNGYEONG, GYEONGBUK_CHEONGDO, GYEONGBUK_GORYEONG, GYEONGBUK_GYEONGSAN,
            GYEONGBUK_YEONGYANG, GYEONGBUK_YEONGDEOK, GYEONGBUK_CHEONGDO,
            GYEONGBUK_GORYEONG, GYEONGBUK_SEONGJU, GYEONGBUK_CHILGOK, GYEONGBUK_YECHEON, GYEONGBUK_UISEONG, GYEONGBUK_BONGHWA,
    ...
    GYEONGNAM("003002015", "경남", Arrays.asList(
            ...
            GYEONGNAM_GIMHAE, GYEONGNAM_MIRYANG, GYEONGNAM_GEORO, GYEONGNAM_YANGSAN,
            GYEONGNAM_YEORYEONG, GYEONGNAM_HAMAN, GYEONGNAM_CHANGNYEONG, GYEONGNAM_GOSEONG,
            GYEONGNAM_NAMHAE, GYEONGNAM_HADONG, GYEONGNAM_SANSCHEONG, GYEONGNAM_HAMAN,
            GYEONGNAM_GOSEONG, GYEONGNAM_HAPCHEON
    )),
